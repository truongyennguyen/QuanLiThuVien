            ...
            <div class="container">
                <div class="row wow fadeInUp">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-center">
                        <div class="jumbotron">
                            <h1 class="text-white">Đăng kí</h1>
                        </div>
                            ...
                            <form action="#" id = "register_form">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control bg-none" placeholder="Full name...">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="mail" class="form-control bg-none" placeholder="Mail...">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="username" class="form-control bg-none" placeholder="Username...">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="confirm_password" class="form-control bg-none" placeholder="Confirm Password...">
                                ...
                                <div class="row">
                                 <div class="col-xs-12 col-sm-6">
                                    <button type="submit" class="btn btn-default">Đăng ký<i class="fa fa-long-arrow-right"></i></button>
                                </div>
                            </div>
