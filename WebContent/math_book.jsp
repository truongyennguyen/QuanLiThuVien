                    ...
                    <aside>
                        <div class="sigle-sidebar">
                            ...
                            <ul class="list-unstyled menu-tip">
                                <li><a href="math_book.jsp">Âm nhạc</a></li>
                                <li><a href="math_book.jsp">Marketing</a></li>
                                <li><a href="math_book.jsp">Chính trị</a></li>
                                <li><a href="math_book.jsp">Lịch sử</a></li>
                                <li><a class="active" href="math_book.jsp">Toán học</a></li>
                                <li><a href="math_book.jsp">Địa lí</a></li>
                                <li><a href="math_book.jsp">Công nghệ</a></li>
                            </ul>
                ...
                <div class="col-xs-12 col-md-10 pull-right">
                    ...
                    <form action="#">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Nhập tên sách hoặc tên tác giả">
                            ...
                            <div class="category-item well yellow">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="space-10"></div>
                                        <p>“In another country or another era, Dennis Cooper’s books would be circulated in secret, explosive ...</p>
                            ...
                            <div class="category-item well yellow">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="space-10"></div>
                                        <p>Working with your hands is said to help with creativity—and before modern inventions ... </p>
                                        <a href="books.jsp" class="text-primary">Xem sách</a>
                                    </div>
                                </div>
                            </div>
