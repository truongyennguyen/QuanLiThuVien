							...
							<div class="category-item well yellow">
								<div class="media">
									...
									<div class="media-body">
										...
										<div class="space-10"></div>
										<p>“In another country or another era, Dennis Cooper’s
											books would be circulated in secret, explosive ...</p>
							...
							<div class="category-item well yellow">
								<div class="media">
									...
									<div class="media-body">
										...
										<div class="space-10"></div>
										<p>Working with your hands is said to help with
											creativity—and before modern inventions ...</p>
										<a href="books.jsp" class="text-primary">Xem sách</a>
									</div>
								</div>
							</div>
