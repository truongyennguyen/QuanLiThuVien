					...
					<ul class="navbar-mobile__list list-unstyled">
						...
						<li class="has-sub"><a class="js-arrow" href="#"> <i
							...
							<ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
								...
								<li><a href="dausach.html">Đầu sách</a></li>
						...
						<div class="row">
							...
							<div class="form-group col-md-6">
								<label>Ảnh Tác Giả</label> <input type="file"
									...
									accept="image/*" value="${dauSachIU.getAnhTacGia() }">
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="form-group col-md-12">
								<label>File PDF</label> <input type="file" name="fileFilePDF"
									class="form-control" 
									accept="application/pdf" value="${dauSachIU.getFilePDF() }">
