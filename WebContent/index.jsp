                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a data-toggle="tab" href="#publisher">Nhà xuất bản</a></li>
                                </ul>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row event-list">
                ...
                <div class="col-xs-12 col-md-7 pull-right">
                    ...
                    <div class="space-20"></div>
                    <div class="fix">
                        <a href="#" class="btn btn-default pull-right hover-btn-primary">Xem thêm <span><i class="icofont icofont-long-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
