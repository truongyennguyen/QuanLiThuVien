                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="establishing_date_input" class=" form-control-label">Ngày lập</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="date" id="establishing_date" name="establishing_date_input"class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="price_input" class=" form-control-label">Mail</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="price" name="price_input"class="form-control" placeholder="Tiền phạt">
                                                </div>
                                            </div>
