					...
					<div class="modal-header">
						<c:if test="${muonTraSachIU != null }">
							<h3 class="modal-title" id="InsertLabel"
								style="font-family: 'Roboto';">Sửa ád</h3>
						</c:if>
						<c:if test="${muonTraSachIU == null }">
							<h3 class="modal-title" id="InsertLabel"
					...
					<div class="modal-body">
						<div class="row">
							<div class="form-group col-md-4">
								...
								<c:if test="${muonTraSachIU != null }">
									<input type="text" name="txtMamuonTraSach" required="required"
										readonly="readonly" class="form-control"
										value="${muonTraSachIU.getMamuonTraSach() }">
								</c:if>
								<c:if test="${muonTraSachIU == null }">
									<input type="text" name="txtMamuonTraSach" required="required"
							...
							<div class="row">
								<div class="form-group col-md-12">
									<label>Mã Thẻ</label> <input type="text" name="txtTenSach"
										class="form-control" required="required"
										value="${muonTraSachIU.getTenSach() }">
								</div>
							</div>
							<div class="row">
								<div class="form-group col-md-4">
								...
								<div class="form-group col-md-12">
									...
									<script type="text/javascript">
										document.getElementById("txtMoTa").value = "${muonTraSachIU.getMoTa()}";
									</script>
								</div>
												...
												<table style="width: 100%"
													...
													<tbody>
														<c:forEach var="muonTraSach" items="${listmuonTraSach}">
															<tr>
																<td><c:out
																		value="${muonTraSach.getMamuonTraSach()}" /></td>
																<%-- <td><c:out value="${muonTraSach.getMaNxb()}" /></td> --%>
																<c:forEach var="nxb" items="${listNxb}">
																	<c:if
																		test="${nxb.getMaNxb() == muonTraSach.getMaNxb()}">
																		<td><c:out value="${nxb.getTenNxb()}" /></td>
																	</c:if>
																</c:forEach>
																<%-- <td><c:out value="${muonTraSach.getMaTheLoai()}" /></td> --%>
																<c:forEach var="theLoai" items="${listTheLoai}">
																	<c:if
																		test="${theLoai.getMaTheLoai() == muonTraSach.getMaTheLoai()}">
																		<td><c:out value="${theLoai.getTenTheLoai()}" /></td>
																	</c:if>
																</c:forEach>
																<td><c:out value="${muonTraSach.getTenSach()}" /></td>
																<td style="word-wrap: break-word;"><c:out
																		value="${muonTraSach.getMoTa()}" /></td>
																<td><c:out value="${muonTraSach.getTacGia()}" /></td>
																<%-- <td><c:out value="${muonTraSach.getAnhTacGiaBlob()}" /></td> --%>
																<td><img alt="Not found"
																	src="http://localhost:8080/QuanLyThuVien/getAnhTacGia?mamuonTraSach=${muonTraSach.getMamuonTraSach() }"
																	width="100px" height="100px"></td>
																<td><c:out value="${muonTraSach.getNamXuatBan()}" /></td>
																<td><c:out value="${muonTraSach.getNgonNgu()}" /></td>
																<%-- <td><c:out value="${muonTraSach.getAnhBiaBlob()}" /></td> --%>
																<td><img alt="Not found"
																	src="http://localhost:8080/QuanLyThuVien/getAnhBia?mamuonTraSach=${muonTraSach.getMamuonTraSach() }"
																	width="100px" height="200px"></td>
																<td><c:out value="${muonTraSach.getTrangThai()}" /></td>
																<td><c:out value="${muonTraSach.getGia()}" /></td>
																<td><c:out value="${muonTraSach.getFilePDFBlob()}" /></td>

																<td><a class="btn btn-warning pull-left"
																	href="/QuanLyThuVien/muonTraSachQuanLy/edit?mamuonTraSach=<c:out value='${muonTraSach.getMamuonTraSach()}' />">Sửa</a>
																	&nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-danger"
																	href="/QuanLyThuVien/muonTraSachQuanLy/delete?mamuonTraSach=<c:out value='${muonTraSach.getMamuonTraSach()}' />">Xóa</a>
																</td>
															</tr>
														</c:forEach>
													</tbody>
